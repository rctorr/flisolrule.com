...
<body data-spy="scroll" data-target="#site-nav">
    ...
    <header id="site-header" class="site-header valign-center">
        <div class="intro">
            ...
            <h2>21 abril, 2018 / CDMX</h2>

            <h1>Festival Latinoamericano de Instalación de Software Libre 2018</h1>

            <p>Centro Cultural El Rule</p>

            <a class="btn btn-white" data-scroll href="#schedule">Mira la Agenda</a>
...
<!--
    ...
    <section id="partner" class="section partner">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="section-title">Con el Gentil Patrocinio De</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-3">
                    <a
                    href="http://www.cultura.cdmx.gob.mx/el-rule"
                    target="_blank"
                    class="partner-box partner-box-1"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="https://www.mozilla.org/es-ES/foundation"
                    target="_blank"
                    class="partner-box partner-box-2"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="https://www.seekurity.com"
                    target="_blank"
                    class="partner-box partner-box-3"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="https://sg.com.mx"
                    target="_blank"
                    class="partner-box partner-box-4"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="http://www.qindel.com/es"
                    target="_blank"
                    class="partner-box partner-box-5"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="https://datank.ai"
                    target="_blank"
                    class="partner-box partner-box-6"></a>
                </div>
                <div class="col-sm-3">
                    <a
                    href="http://cryptobox.mx/#/"
                    target="_blank"
                    class="partner-box partner-box-7"></a>
                </div>
            </div>
<!--
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="social-block">
                        <!-- <li><a href=""><i class="ion-social-twitter"></i></a></li> -->
                        <li><a href="https://www.facebook.com/groups/195413897714708/"><i class="ion-social-facebook"></i></a></li>
                        <!-- <li><a href=""><i class="ion-social-linkedin-outline"></i></a></li> -->
                        <!-- <li><a href=""><i class="ion-social-googleplus"></i></a></li> -->
                    </ul>
                </div>
